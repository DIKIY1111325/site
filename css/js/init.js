    ...
    */
    ...
    $('button.form-control').on('click', function(event) {
        ...
        if (!isValid) {
            ...
            alert("НАСТРОЙКИ VPN СЕРВЕРА СКОПИРОВАНЫ. Для использования, установите любую программу-клиент из оффициального appStore https://www.apple.com/us/search/vless?src=serp/ или GoogleStore https://play.google.com/store/apps/details?id=app.hiddify.com ");
        }
    });
});